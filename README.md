...
应用使用本地商品图片来提升加载速度和用户体验：

- **图片位置**：`src/assets/product-images/`
- **图片服务**：`ImageService` 提供商品名称到图片文件的映射
- **映射机制**：通过商品名称自动匹配对应的本地图片文件
- **默认图片**：未匹配到图片的商品显示其所属类别的默认图片

### 支持的商品类别默认图片
- **电子产品**：Generic Electronics Item.jpg
- **家具**：Desks.jpg
- **服装**：T-shirt.jpg
- **工具**：Hammer.jpg
- **书籍**：Book.jpg
